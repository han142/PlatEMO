function [outputArg1,outputArg2] = TSSKEA(inputArg1,inputArg2)
%% TSSKEA identify node-network biomarkers
%   此处显示详细说明
    experiment_num=30;
    Problem.maxFE=30000;
    Problem.N=300;
...
%         cons=Cons;%约束条件
        ...
        filename=strcat('DE_node_biomarker_TSSKEA_NDSol.mat');
        save(filename,'FVV');
        filename1=strcat('DE_node_biomarker_TSSKEA_Num.mat');
        save(filename1,'c');
        filename2=strcat('DE_node_biomarker_TSSKEA_POP.mat');
        save(filename2,'Final_Pop');
        filename3=strcat('DE_node_biomarker_TSSKEA_boxchart.mat');
        save(filename3,'Non_dominated_sol');
        filename4=strcat('DE_node_biomarker_TSSKEA_pho.mat');
        save(filename4,'R');
