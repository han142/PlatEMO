function [OffMask,poss_s_num] = Operator_adrpv(ParentMask,Site,rbm,allOne,other,D_score,test_adjacency,pv,UpdateRatio)
    ...
    if any(Site)
        ...
        OffMaskT2(:,other) = Cross_pv(Parent1Mask(~Site1,other),Parent2Mask(~Site2,other),pv(1,other));
